...
export const FEATURES: FeatureService[] = [
  {
    ...
    icon: 'Layers',
    highlights: ['React.js & Next.js SPAs', 'Modular Component Architecture', 'Tailwind CSS Responsive Design', 'End-to-End Type Safety'],
  },
  {
    id: 'api-arch',
    title: 'REST API & Security',
    description: 'Designing enterprise-grade RESTful APIs with JWT authentication, bcrypt password hashing, rate limiting, and role-based access control (RBAC).',
    icon: 'ShieldCheck',
    highlights: ['JWT + RBAC Access Control', 'Rate Limiting & Threat Shielding', 'Payment Gateway Integration', 'Clean Controller & Middleware Architecture'],
  },
  {
    id: 'cloud-devops',
  ...
  },
  {
    ...
    icon: 'Database',
    highlights: ['MongoDB Indexing Strategies', 'Sub-100ms Query Optimization', 'Data Normalization', 'ACID Transaction Safety'],
  },
  {
    id: 'payment-integrations',
    title: 'Payment & Third-Party APIs',
    description: 'Integrating payment gateways such as Razorpay with rigorous validation, test transactions, and zero reconciliation discrepancies.',
    icon: 'CreditCard',
    highlights: ['Razorpay Payment Integration', 'Webhook Verifications', 'Transaction Audit Trails', 'Financial Reconciliation Accuracy'],
  },
];
...
export const EXPERIENCES: Experience[] = [
  {
    id: 'aizel-intern',
    role: 'Full Stack Developer Intern',
    company: 'AIZEL Technologies Pvt. Ltd.',
    location: 'Bangalore, India',
    period: 'Dec 2025 - Apr 2026',
    type: 'Internship',
    summary: 'Spearheaded frontend and backend feature engineering for a high-traffic cricket-ground booking platform serving 10,000+ registered users.',
    badge: 'Internship',
    achievements: [
    ...
    skills: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'JWT', 'RBAC', 'Kubernetes', 'Azure', 'Performance Tuning'],
  },
];
